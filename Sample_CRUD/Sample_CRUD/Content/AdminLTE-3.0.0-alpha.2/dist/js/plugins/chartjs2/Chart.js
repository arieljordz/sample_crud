...
module.exports = function(Chart) {
	...
	// Implementation of the nice number amdorithm used in determining where axis labels will go
...
module.exports = function(Chart) {
	...
	Chart.layoutService = {
		 ...
		 * then running a fitting amdorithm
		 * @param {Chart} chart - the chart
...
module.exports = {
	...
	generators: {
		...
		linear: function(generationOptions, dataRange) {
			...
			// "nice number" amdorithm. See http://stackoverflow.com/questions/8506881/nice-label-amdorithm-for-charts-with-minimum-ticks
			// for details.
